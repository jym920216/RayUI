...
RayUIData = {
	...
	["profiles"] = {
		["冷魂夺情 - 石锤"] = {
			...
			["layoutchosen"] = true,
			["movers"] = {
				["目标buff&debuffHolder"] = "TOPRayUIParentTOP-294-431",
				["焦点buff&debuffHolder"] = "TOPRayUIParentTOP-300-334",
				["RayUI_CombatText_Healing Mover"] = "TOPLEFTRayUIParentTOPLEFT332-487",
				["RayUF_RaidMover"] = "BOTTOMLEFTRayUIParentBOTTOMLEFT10331",
				["RayUF_TargetMover"] = "BOTTOMRayUIParentBOTTOM294463",
				["RayUI_CombatText_OutGoing Mover"] = "TOPRayUIParentTOP204-378",
